                     ...
                     andMainView:(UIViewController *)mainVC
{
    if(self = [super init]){
        ...
        CGFloat grey_height = self.mainVC.view.frame.size.height - 20 ;
        CGFloat grey_width = self.mainVC.view.frame.size.width;
        self.grayView = [[UIView alloc]initWithFrame:CGRectMake(0, 20, grey_width, grey_height)];
        ...
        self.leftTableview.frame = CGRectMake(0, 20, kScreenWidth - kMainPageDistance, kScreenHeight - 20);
