...
//    [view addSubview:imageView];
    UILabel *mLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 50, view.width, 30)];
    mLab.centerX = view.centerX;
    ...
    view.backgroundColor = [self getUIcolorByRed:139 green:195 blue:74];
    self.nameLable = mLab;
    return view;
}

-(UIColor *)getUIcolorByRed :(int)red green:(int)green blue:(int)blue{
